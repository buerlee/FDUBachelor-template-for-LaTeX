% !Mode:: "TeX:UTF-8"
%% 请使用 XeLaTeX 编译本文.
% \documentclass{FDUBachelor}% 选项 forprint: 交付打印时添加, 避免彩色链接字迹打印偏淡. 即使用下一行:
\documentclass[forprint]{FDUBachelor}

\begin{document}
%%%%%%% 下面的内容, 据实填空.

\title{}
\papername{六学与人工智能}                                      %论文题目
\Cschoolname{大数据学院}                         %学院中午名
\author{张三}                                             %作者中文名
\Cmajor{计算机科学与技术}                                  %专业中文名
\studentid{15307130000}                                          %学号
\Csupervisor{徐志平 \quad 讲师}                            %指导教师中文名、职称
\Eauthor{San Zhang}                                        %作者英文名
\Esupervisor{Prof.~Zhi ping Xu}                            %指导教师英文名、职称
\Emajor{Computer Science and Technology}                   %专业英文名
\Eschoolname{School of Data Science}    %学院英文名
\date{二〇一六年五月}                                       %日期
...
\begin{tabular}{ll}
\hline
   \verb|\documentclass{FDUBachelor}|                     &  毕业论文 \\
   \verb|\documentclass[forprint]{FDUBachelor}|        &  毕业论文打印版 \\
\hline
\end{tabular}
\end{table}
相关解释见下节.
...
本文档下载更新地址: \url{https://github.com/Wonsa0823/FDUBachelor-template-for-LaTeX/}. 

问题反馈及建议, 请在 https://github.com/Wonsa0823/FDUBachelor-template-for-LaTeX/issues 留言
...
\begin{tabular}{r|r|l}
	...
	\multicolumn{2}{l|}{FDUBachelor.cls }             & 定义文档格式的 class file. 不可删除. \\ \hline\hline
\end{tabular}
\end{table}
...
\begin{itemize}
    ...
    这里有原文作者写的一个关于初次使用~pgf~的帖子:\\    \url{http://bbs.ctex.org/forum.php?mod=viewthread&tid=30480}.
    ...
    \item 幻灯片\index{幻灯片}的制作, 建议使用~Beamer. 这
\end{itemize}
